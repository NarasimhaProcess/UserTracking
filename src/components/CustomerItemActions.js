      ...
      {showActions && (
        <View style={styles.actionsMenu}>
          <TouchableOpacity style={styles.actionMenuItem} onPress={() => {
            setShowActions(false); // Close actions
            setIsEditMode(true);
          ...
          <TouchableOpacity style={styles.actionMenuItem} onPress={() => { setShowActions(false); openTransactionModal(item); }}>
...
const styles = StyleSheet.create({
  ...
  actionsMenu: {
    ...
    flexDirection: 'row',
    flexWrap: 'wrap',
    minWidth: 180, // Increased width to accommodate icons
  },
  actionMenuItem: {
    padding: 4,
